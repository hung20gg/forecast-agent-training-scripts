...
if [ $USE_MEGATRON -eq 1 ]; then
    ...
    pip install "onnxscript==0.6.0"
    NVTE_FRAMEWORK=pytorch pip3 install --no-deps git+https://github.com/NVIDIA/TransformerEngine.git@v2.12
    pip3 install --no-deps git+https://github.com/NVIDIA/Megatron-LM.git@core_v0.16.0
fi
